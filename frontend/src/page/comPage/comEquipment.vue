    ...
    <div class="table-container">
      <el-card class="box-card" shadow="hover">
        ...
        >
          ...
          <el-table-column prop="type" label="所属部门" min-width="120" show-overflow-tooltip>
            <template #default="scope">
              <div class="type-cell">
  ...
  setup(){
    ...
    async function depEquipmentList(){
      ...
      try {
        ...
        const res = await new proxy.$request(proxy.$urls.m().equipmentList + '?com_id=' + com_id).modeget();
        // 处理返回数据
